      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <a href="" className="py-2, px-2 font-medium text-light-gray">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 496 512"
            ...
            <a href="" className="py-2, px-2 font-medium text-light-gray">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="fill-light-gray w-5 h-5">
          ...
          <div className="md:hidden flex items-center">
            ...
            >
              <svg
                className=" w-6 h-6 text-light-gray hover:text-green"
                x-show="!showMenu"
                fill="none"
                strokeLineCap="round"
